...
var _Signout = require('./Signout.vue');
...
exports.default = {
  ...
  methods: {
    login: function login() {
      ...
      _auth2.default.login(this, this.credential, '/').then(function (response) {
        _this.valid_creds = true;
      }, function (err) {
        _this.valid_creds = false;
      });
    }
  }
};
...
exports.initJoliPlugins = initJoliPlugins;
function initJoliPlugins() {
